...
public class ListToSetToMap {
    ...
    public static void main(String[] args) {
        ...
        // juntaDirectiva.add(new Persona("45678901D", "María", "López",
        ...
        // map con keys el nif de la persona y como valor de ese key la persona en
        // cuestión
        // Si hay keys duplicadas, entonces se lanza una excepción y no se crea el map
        Map<String, Persona> mapa = juntaDirectiva.stream()
